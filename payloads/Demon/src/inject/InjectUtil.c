...
DWORD GetReflectiveLoaderOffset( PVOID ReflectiveLdrAddr )
{
    ...
    ExportDir           = (PVOID)((UINT_PTR)ReflectiveLdrAddr + Rva2Offset( NtHeaders->OptionalHeader.DataDirectory[ IMAGE_DIRECTORY_ENTRY_EXPORT ].VirtualAddress, (UINT_PTR)ReflectiveLdrAddr));
    ...
    {
        FunctionName = ( PCHAR )( ReflectiveLdrAddr + Rva2Offset( DEREF_32( AddrOfNames ), (UINT_PTR)ReflectiveLdrAddr) );
