...
type HavocConfig struct {
	...
	LLM       *LLMConfig      `yaotl:"LLM,block"`
}

// LLMConfig holds the configuration for the autonomous LLM agent.
type LLMConfig struct {
	Provider  string `yaotl:"Provider"`
	ApiKey    string `yaotl:"ApiKey,optional"`
	Model     string `yaotl:"Model"`
	BaseUrl   string `yaotl:"BaseUrl,optional"`
	MaxSteps  int    `yaotl:"MaxSteps,optional"`
	MaxTokens int    `yaotl:"MaxTokens,optional"`
}
